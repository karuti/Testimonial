  ...
  return (
    <>
      ...
      <TestimonialCard
        ...
        profile={
          <img src="/images/brian-rwehabura-fanmilk.png" alt="FanMilk" />
        }
        ...
        textcta={
          <a
            style={{ color: "#febd55" }}
            href="https://blog.fieldproapp.com/fan-milk-digitising-the-field-vendor-management-by-franchisees-of-a-dairy-company-in-west-africa"
          >
            {" "}
            Read FanMilk’s Case Study
          </a>
        }
      />
      ...
      <TestimonialCardReverse
        ...
        textcta={
          <a
            style={{ color: "#febd55" }}
            href="https://blog.fieldproapp.com/gaselia-implementing-the-road-to-market-methodology-for-a-west-african-beverages-group"
          >
            Read Gaselia’s Case Study
          </a>
        }
      />
      <TestimonialCard
        ...
        textcta={
          <a
            style={{ color: "#febd55" }}
            href="https://blog.fieldproapp.com/vodacom-mozambique-digitising-the-customer-education-btl-activities"
          >
            Read Vodacom’s Case Study
          </a>
        }
      />
      <TestimonialCardReverse
        ...
        textcta={
          ...
          >
            Learn more about our Geo-Tracking feautures
          </a>
        }
      />
      <TestimonialCard
        ...
        textcta={
          <a
            style={{ color: "#febd55" }}
            href="https://blog.fieldproapp.com/groupe-seb-getting-full-visibility-on-merchandisers-deployed-in-kenya-modern-trade"
          >
            Read Seb's Case Study
          </a>
        }
      />
      <TestimonialCardReverse
        companypicture={
          <img src="/images/vodacom-image.png" alt="Rural Digital Media" />
        }
        ...
        profile={
          <img src="/images/Brian-RuralMedia.png" alt="Rural  Digital Media" />
        }
        ...
        textcta={
          <a
            style={{ color: "#febd55" }}
            href="https://fieldproapp.com/retail/"
          >
            Learn more about field force automation
          </a>
        }
      />
      <TestimonialCard
        ...
        textcta={
          <a style={{ color: "#febd55" }} href="https://fieldproapp.com/sales/">
            Learn more about our Field Sales features
          </a>
        }
      />
      <TestimonialCardReverse
        ...
        textcta={
          <a style={{ color: "#febd55" }} href="https://fieldproapp.com/app/">
            Learn more about the FieldPro Mobile App
          </a>
        }
      />
      <TestimonialCard
        ...
        profile={
          <img src="/images/armelle-schlumberger-image .png" alt="Danone" />
        }
        ...
        textcta={
          <a
            ...
            href="https://fieldproapp.com/retail/"
          >
            Learn more about our Retail Audit
          </a>
        }
      />
      ...
      <TestimonialCardReverse
        ...
        profile={
          <img src="/images/richard-yego-image.png" alt="Airtel Uganda" />
        }
        ...
        textcta={
          <a
            style={{ color: "#febd55" }}
            href="https://blog.fieldproapp.com/managing-a-mobile-money-agent-network-with-digital-tools"
          >
            Read Airtel’s case study
          </a>
        }
      />
      <TestimonialCard
      ...
      />
      <BottomCta tagline="Digitise your field operations today" />
      <Footer />
    </>
  )
}
